...
echo -e "\e[34mThis script will configure your zsh. Do not run this script as sudo. This script should only be run on a fresh install of a Red Hat-based system. You can cancel the script within the next 5 seconds\e[0m"
sleep 5
